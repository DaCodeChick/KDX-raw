...
public:
	...
	/**
	 * @brief Divides two unsigned long long integers and returns the result as an unsigned long long.
	 * 
	 ...
	 * 
	 * @param ioInit Pointer to an unsigned integer used for random number generation initialization.
