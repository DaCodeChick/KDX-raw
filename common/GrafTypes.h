...
struct EXPORT SRect
{
	 ...
	 * @param inRectA
	 * @param inRectB 
	 * @return true if the union was successfully calculated, false if the rectangles do not intersect.
	 */
	...
	/**
	 * @brief Moves the rectangle to a new position defined by the specified left and top coordinates.
	 * 
	 * @param inRect
	 * @param inLeft
	 * @param inTop 
