...
public:
	 ...
	 * @return Pointer to the first occurrence of the byte in the memory block, or nullptr if not found.
	 */
	 ...
	 * @param inData Pointer to the block of memory to search in.
	 * @param inSize Size of the memory block to search in bytes.
	 * @return Pointer to the last occurrence of the byte in the memory block, or nullptr if not found.
	 */
