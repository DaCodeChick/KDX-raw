...
public:
	 ...
	 * @return The lowercase version of the character if it is an uppercase letter; otherwise, returns the character unchanged.
	 */
	 ...
	 * 
	 * @param inChar The character to convert.
	 * @return The uppercase version of the character if it is a lowercase letter; otherwise, returns the character unchanged.
	 */
